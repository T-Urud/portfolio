    ...
    >
      <div className="px-2 py-4 bg-white rounded-2xl cursor-pointer">
        <div className="flex justify-between w-full z-20 mb-2">
          <h2 className="font-bold text-sm">{projectData.title}</h2>
        </div>
      ...
      >
        <div className="mb-3">
          <div className="flex items-center gap-1">
            ...
            <h2 className="font-semibold text-sm">Quel est l'objectif ?</h2>
          </div>
        ...
        <div className="mb-3">
          <div className="flex items-center gap-1">
            ...
            <h2 className="font-semibold text-sm">Technologies utilisées</h2>
          </div>
          <div>
            <ul>
              {projectData.technos.map((techno, index) => (
                <li
                  key={index}
                  className="font-light text-[0.7rem] text-gray-400"
                >
                  {techno}
                </li>
              ))}
        ...
        <div className="mb-3">
          <div className="flex items-center gap-1">
            ...
            <h2 className="font-semibold text-sm">Difficultés rencontrées</h2>
          </div>
          <div>
            <p className="font-light text-[0.7rem] text-gray-400">
